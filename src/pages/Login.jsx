/**
 * src/pages/Login.jsx
 * Firebase email/password + Google sign-in page.
 * Design: #040B18 dark, gold #F5A623, teal #00D4B8, glassmorphism card.
 */
...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      const res = await fetch(`${BASE_URL}/api/onboarding/status/${result.user.uid}`, {
  ...
  return (
    <div style={S.page}>
      <style>{`
        ...
        .forgot-link { color: var(--gold); font-size:0.82rem; text-decoration:none; transition: opacity 0.2s; }
      ...
      >
        ...
        <GlassCard style={S.card}>
          ...
          {/* Email form */}
          <form onSubmit={handleEmailLogin} style={S.form} noValidate>
            <input
            ...
            <GoldButton
              style={{ width: '100%', marginTop: '0.25rem', padding: '0.85rem', fontSize: '0.95rem', fontWeight: 700, opacity: loading ? 0.75 : 1 }}
              onClick={() => {}}
            >
          ...
          <p style={S.footer}>
            ...
            <Link to="/signup" style={S.authLink}>Sign Up</Link>
          </p>
        </GlassCard>
      </motion.div>
    </div>
